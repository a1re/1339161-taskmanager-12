...
export default class Statistics extends SmartView {
  ...
  _renderColorsChart(colorsCtx, tasks) {
  ...
  _renderDaysChart(daysCtx, tasks, dateFrom, dateTo) {
  ...
  _setCharts() {
    ...
    this._colorsChart = this._renderColorsChart(colorsCtx, tasks);
    this._daysChart = this._renderDaysChart(daysCtx, tasks, dateFrom, dateTo);
  }
}
